file://<WORKSPACE>/kernel/Kernel.scala
empty definition using pc, found symbol in pc: 
semanticdb not found
empty definition using fallback
non-local guesses:
	 -chisel3/KERNEL_DATA_WIDTH.
	 -chisel3/KERNEL_DATA_WIDTH#
	 -chisel3/KERNEL_DATA_WIDTH().
	 -chisel3/util/KERNEL_DATA_WIDTH.
	 -chisel3/util/KERNEL_DATA_WIDTH#
	 -chisel3/util/KERNEL_DATA_WIDTH().
	 -mycpu/core/os/KERNEL_DATA_WIDTH.
	 -mycpu/core/os/KERNEL_DATA_WIDTH#
	 -mycpu/core/os/KERNEL_DATA_WIDTH().
	 -mycpu/utils/KERNEL_DATA_WIDTH.
	 -mycpu/utils/KERNEL_DATA_WIDTH#
	 -mycpu/utils/KERNEL_DATA_WIDTH().
	 -mycpu/common/KERNEL_DATA_WIDTH.
	 -mycpu/common/KERNEL_DATA_WIDTH#
	 -mycpu/common/KERNEL_DATA_WIDTH().
	 -KERNEL_DATA_WIDTH.
	 -KERNEL_DATA_WIDTH#
	 -KERNEL_DATA_WIDTH().
	 -scala/Predef.KERNEL_DATA_WIDTH.
	 -scala/Predef.KERNEL_DATA_WIDTH#
	 -scala/Predef.KERNEL_DATA_WIDTH().
offset: 909
uri: file://<WORKSPACE>/kernel/Kernel.scala
text:
```scala
package HwOS.kernel
...
class Kernel {
  ...
  def createConnection(driverName: String): VirtualResourceHandle = {
    ...
    val channel = Wire(new ClientChannel(32, KERNEL@@_DATA_WIDTH))
