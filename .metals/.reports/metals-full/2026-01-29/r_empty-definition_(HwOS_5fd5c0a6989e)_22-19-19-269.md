file://<WORKSPACE>/kernel/HwProcess.scala
...
non-local guesses:
	 -chisel3/Option#
	 -chisel3/util/Option#
	 -mycpu/core/os/Option#
	 -mycpu/utils/Option#
	 -Option#
	 -scala/Predef.Option#
offset: 1424
uri: file://<WORKSPACE>/kernel/HwProcess.scala
text:
```scala
package HwOS.kernel
...
abstract class HwProcess(val pName: String)(implicit parentCtx: Option[ProcessContext], kernel: Kernel) {
  ...
  def spawn[T <: HwProcess](childGen: (Op@@tion[ProcessContext], Kernel) => T)
