error id: E03516FEB1E999BC3D2123A8321200FC
file://<WORKSPACE>/src/main/scala/HwOS/kernel/SysDefs.scala
### java.lang.AssertionError: assertion failed: bad position: [256:73]
...
action parameters:
offset: 1516
uri: file://<WORKSPACE>/src/main/scala/HwOS/kernel/SysDefs.scala
text:
```scala
package HwOS.kernel
...
// 3. 返回结果包
// ==============================================================================
class SysResult ext@@ends Bundle {
  // [修复] 使用全局定义的宽位宽
