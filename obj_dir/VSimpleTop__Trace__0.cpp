...
void VSimpleTop___024root__trace_chg_0_sub_0(VSimpleTop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgIData(oldp+147,(vlSelfRef.SimpleTop__DOT__res),32);
        bufp->chgCData(oldp+148,(vlSelfRef.SimpleTop__DOT__pcReg),3);
        bufp->chgBit(oldp+149,(vlSelfRef.SimpleTop__DOT__stall));
        bufp->chgBit(oldp+150,(vlSelfRef.SimpleTop__DOT__intents_0_acquire));
        bufp->chgBit(oldp+151,(vlSelfRef.SimpleTop__DOT___GEN_0));
        bufp->chgBit(oldp+152,(vlSelfRef.SimpleTop__DOT__intents_0_release));
        bufp->chgBit(oldp+153,(vlSelfRef.SimpleTop__DOT__intents_0_reg));
        bufp->chgBit(oldp+154,(vlSelfRef.SimpleTop__DOT__doneWire));
        bufp->chgIData(oldp+155,(vlSelfRef.SimpleTop__DOT__op1_1),32);
        bufp->chgIData(oldp+156,(vlSelfRef.SimpleTop__DOT__res_1),32);
        bufp->chgCData(oldp+157,(vlSelfRef.SimpleTop__DOT__pcReg_1),3);
        bufp->chgBit(oldp+158,(vlSelfRef.SimpleTop__DOT__intents_1_acquire));
        bufp->chgBit(oldp+159,(vlSelfRef.SimpleTop__DOT___GEN_4));
        bufp->chgBit(oldp+160,(vlSelfRef.SimpleTop__DOT__intents_1_release));
        bufp->chgBit(oldp+161,(vlSelfRef.SimpleTop__DOT__intents_1_reg));
        bufp->chgBit(oldp+162,(vlSelfRef.SimpleTop__DOT__doneWire_1));
        bufp->chgIData(oldp+163,(vlSelfRef.SimpleTop__DOT__addrVal),32);
        bufp->chgIData(oldp+164,(vlSelfRef.SimpleTop__DOT__dataVal),32);
        bufp->chgCData(oldp+165,(vlSelfRef.SimpleTop__DOT__pcReg_2),3);
        bufp->chgBit(oldp+166,(vlSelfRef.SimpleTop__DOT__stall_6));
        bufp->chgBit(oldp+167,(vlSelfRef.SimpleTop__DOT__intents_2_acquire));
        bufp->chgBit(oldp+168,(vlSelfRef.SimpleTop__DOT__intents_2_release));
        bufp->chgBit(oldp+169,(vlSelfRef.SimpleTop__DOT__doneWire_2));
        bufp->chgIData(oldp+170,(vlSelfRef.SimpleTop__DOT__addrVal_1),32);
        bufp->chgIData(oldp+171,(vlSelfRef.SimpleTop__DOT__memData),32);
        bufp->chgCData(oldp+172,(vlSelfRef.SimpleTop__DOT__pcReg_3),3);
        bufp->chgBit(oldp+173,(vlSelfRef.SimpleTop__DOT__intents_3_acquire));
        bufp->chgBit(oldp+174,(vlSelfRef.SimpleTop__DOT__io_1_req));
        bufp->chgBit(oldp+175,(vlSelfRef.SimpleTop__DOT__io_1_isWr));
        bufp->chgIData(oldp+176,(vlSelfRef.SimpleTop__DOT__io_1_addr),32);
        bufp->chgBit(oldp+177,(vlSelfRef.SimpleTop__DOT___GEN_17));
        bufp->chgCData(oldp+178,(((IData)(vlSelfRef.SimpleTop__DOT___GEN_17)
                                   ? 3U : 0U)),2);
        bufp->chgBit(oldp+179,(vlSelfRef.SimpleTop__DOT__intents_3_release));
        bufp->chgCData(oldp+180,(((IData)(vlSelfRef.SimpleTop__DOT____VdfgRegularize_h78706270_0_1)
                                   ? 3U : 0U)),2);
        bufp->chgBit(oldp+181,(vlSelfRef.SimpleTop__DOT__doneWire_3));
        bufp->chgIData(oldp+182,(vlSelfRef.SimpleTop__DOT__op1_2),32);
        bufp->chgIData(oldp+183,(vlSelfRef.SimpleTop__DOT__op2),32);
        bufp->chgIData(oldp+184,(vlSelfRef.SimpleTop__DOT__res_2),32);
        bufp->chgCData(oldp+185,(vlSelfRef.SimpleTop__DOT__pcReg_4),3);
        bufp->chgBit(oldp+186,(vlSelfRef.SimpleTop__DOT__intents_4_acquire));
        bufp->chgBit(oldp+187,(vlSelfRef.SimpleTop__DOT__intents_4_release));
        bufp->chgBit(oldp+188,(vlSelfRef.SimpleTop__DOT__intents_4_reg));
        ...
        __Vtemp_3[4U] = (IData)(((((QData)((IData)(vlSelfRef.SimpleTop__DOT__pcReg_4)) 
                                 ...
                                 >> 0x00000020U));
        bufp->chgWData(oldp+189,(__Vtemp_3),160);
        bufp->chgCData(oldp+194,(((((IData)(vlSelfRef.SimpleTop__DOT__activeReg_4) 
                                    << 4U) | (((IData)(vlSelfRef.SimpleTop__DOT__activeReg_3) 
                                               << 3U) 
                                              | ((IData)(vlSelfRef.SimpleTop__DOT__activeReg_2) 
                                                 << 2U))) 
                                  | (((IData)(vlSelfRef.SimpleTop__DOT__activeReg_1) 
                                      << 1U) | (IData)(vlSelfRef.SimpleTop__DOT__activeReg)))),5);
        bufp->chgBit(oldp+195,(vlSelfRef.SimpleTop__DOT__unnamedblk1__DOT__unnamedblk2__DOT__stall_7));
        bufp->chgBit(oldp+196,(vlSelfRef.SimpleTop__DOT__unnamedblk1__DOT__unnamedblk2__DOT__stall_8));
        bufp->chgIData(oldp+197,(vlSelfRef.SimpleTop__DOT__unnamedblk1__DOT__unnamedblk2__DOT__io_1_wdata),32);
        bufp->chgBit(oldp+198,(vlSelfRef.SimpleTop__DOT__unnamedblk1__DOT__unnamedblk2__DOT__stall_10));
        bufp->chgBit(oldp+199,(vlSelfRef.SimpleTop__DOT__unnamedblk1__DOT__unnamedblk2__DOT__stall_13));
        bufp->chgBit(oldp+200,(vlSelfRef.SimpleTop__DOT__unnamedblk1__DOT__unnamedblk2__DOT__stall_14));
    }
    bufp->chgBit(oldp+201,(vlSelfRef.clock));
    bufp->chgBit(oldp+202,(vlSelfRef.reset));
    bufp->chgBit(oldp+203,(vlSelfRef.io_start));
    bufp->chgBit(oldp+204,(vlSelfRef.io_done));
    bufp->chgIData(oldp+205,(vlSelfRef.io_r1),32);
    bufp->chgIData(oldp+206,(vlSelfRef.io_r2),32);
    bufp->chgIData(oldp+207,(vlSelfRef.io_r3),32);
    bufp->chgIData(oldp+208,(vlSelfRef.io_r4),32);
    bufp->chgCData(oldp+209,((0x0000001fU & (- (IData)((IData)(vlSelfRef.io_start))))),5);
    bufp->chgCData(oldp+210,(((((IData)(vlSelfRef.io_done) 
                                << 4U) | (((IData)(vlSelfRef.SimpleTop__DOT__doneWire_3) 
                                           << 3U) | 
                                          ((IData)(vlSelfRef.SimpleTop__DOT__doneWire_2) 
                                           << 2U))) 
                              | (((IData)(vlSelfRef.SimpleTop__DOT__doneWire_1) 
                                  << 1U) | (IData)(vlSelfRef.SimpleTop__DOT__doneWire)))),5);
}
