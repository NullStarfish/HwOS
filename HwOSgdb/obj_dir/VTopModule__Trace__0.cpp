...
void VTopModule___024root__trace_chg_0_sub_0(VTopModule___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        bufp->chgBit(oldp+0,(vlSelfRef.TopModule__DOT__activeReg));
        bufp->chgBit(oldp+1,(vlSelfRef.TopModule__DOT__doneReg));
        bufp->chgCData(oldp+2,(vlSelfRef.TopModule__DOT__pcReg),3);
        bufp->chgIData(oldp+3,(vlSelfRef.TopModule__DOT__pcReg),32);
    }
    bufp->chgBit(oldp+4,(vlSelfRef.clock));
    bufp->chgBit(oldp+5,(vlSelfRef.reset));
    bufp->chgBit(oldp+6,(vlSelfRef.io_start));
    bufp->chgBit(oldp+7,(vlSelfRef.io_done));
}
